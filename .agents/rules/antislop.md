...
For UI, copy, people, mobile layout, or code comments work, load the matching antislop skill before starting. Each skill is located in `.agents/skills/<name>/SKILL.md`:
