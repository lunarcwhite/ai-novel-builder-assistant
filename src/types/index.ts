...
export const exportQuerySchema = z.object({
  format: z.preprocess(
    ...
    z.enum(["txt", "md", "docx"], {
      errorMap: () => ({ message: "Format ekspor harus 'txt', 'md', atau 'docx'." }),
    })
  ),
